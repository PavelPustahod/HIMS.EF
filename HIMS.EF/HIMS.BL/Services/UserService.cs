...
namespace HIMS.BL.Services
{
    public class UserService : IUserService
    {
        ...
        {
            ApplicationUser user = await Database.UserSecurityManager.FindByEmailAsync(userDto.Email);
            if (user == null)
            {
        ...
        public async Task<ClaimsIdentity> Authenticate(UserDTO userDto)
        {
            ...
            // finding the user
            ApplicationUser user = await Database.UserSecurityManager.FindAsync(userDto.Email, userDto.Password);
